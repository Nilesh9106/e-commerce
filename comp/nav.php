...
<nav class="navbar navbar-light bg-light sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php">Amazon Zinda Hey</a>
        <!-- <div class="d-flex"> -->
        <div class="my-2 d-flex flex-wrap">
            <div class="d-flex large-drop">
                ...
                <?php } ?>
                <a class="btn menu d-none  btn-outline-dark  btn-sm" href="wishlist.php" title="Wish list"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
