    ...
    <div class="container-fluid">
        ...
        <div class="my-2 d-flex flex-wrap">
            <div class="d-flex large-drop">
                ...
                <?php } ?>
                <a class="btn menu  btn-outline-dark  btn-sm" href="team.php" title="Wish list"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                ...
                <div class="my-2 d-flex flex-wrap small-drop">
                    ...
                    <a class="btn menu d-md-none  btn-outline-dark  btn-sm" title="Wish list"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
